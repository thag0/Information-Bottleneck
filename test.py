...
def plot_tishby_dataset():
    ...
    # indicadores para facilitar a referência no doc do trabalho
    axes[0].set_xlabel("(A)", fontsize=20, fontweight="bold")
    axes[1].set_xlabel("(B)", fontsize=20, fontweight="bold")
