...
from modules.ip_plot import plot_information_plane, save_information_plane
...
if __name__ == '__main__':
    ...
    dir = "./results/new/tishby/12-10-7-5-4-3-2-1/result"
    ...
    for _ in range(iterations):
        ...
        save_information_plane(I_XT, I_TY, I_XY, mn['epochs'], dir)